...
$System_Stalker = $env:SystemDrive+"\Users\charles.kwiatkowski\Desktop\Dub_Test\"+$FolderName
...
$SaveLocation = $System_Stalker+"\"+$FileName
$ADGroup = Get-ADGroup -Filter * | findstr /v "ObjectClass"
