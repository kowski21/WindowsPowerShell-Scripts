...
$smtp = "mail.wip.socom.mil" 

$credential = Get-Credential
 
$to = "<Charles.Kwiatkowski@socom.mil>" 
 
$from = "<Charles.Kwiatkowski@socom.mil>" 
...
send-MailMessage -SmtpServer $smtp -To $to -From $from -Subject $subject -Body $body -BodyAsHtml -Credential $credential
